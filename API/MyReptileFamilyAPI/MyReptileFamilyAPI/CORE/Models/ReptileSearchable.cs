...
public class ReptileSearchable
{
    ...
    /// </summary>
    public Range Price { get; set; } = new(new Index(0), new Index(int.MaxValue));
    ...
    /// <summary>
    ///     What rating would you like the seller to have. rating is from 0-5 what ever number given it will search for that
    ///     number and higher.
    /// </summary>
    [Range(0, 5)]
